...
pub struct Connection {
    ...
    /// Command run automatically in the interactive shell right after connect
    /// (a per-connection login script). Empty/None = nothing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub on_connect: Option<String>,
    /// Visual color tag (hex, e.g. "#ef4444") for the connection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SerialConfig {
    ...
    pub parity: String,
    /// Flow control: "none" | "rtscts" | "xonxoff" | "hardware"
...
pub struct RemoteEntry {
    ...
    /// Unix permission bits (`& 0o7777`), if the server reported them.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<u32>,
}
