...
export function TitleBar() {
  ...
  const onDrag = useCallback((e: MouseEvent) => {
    ...
    const win = tryCurrentWindow();
    void win?.startDragging().catch((e) => console.warn(e));
  }, []);

  const onDoubleClick = useCallback(() => {
    const win = tryCurrentWindow();
    void win?.toggleMaximize().catch((e) => console.warn(e));
  }, []);

  const minimize = useCallback(() => {
    const win = tryCurrentWindow();
    void win?.minimize().catch((e) => console.warn(e));
  }, []);
  ...
  const close = useCallback(() => {
    const win = tryCurrentWindow();
    void win?.close().catch((e) => console.warn(e));
  }, []);
