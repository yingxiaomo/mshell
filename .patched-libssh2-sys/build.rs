...
fn main() {
    ...
    if target.contains("windows") {
        ...
        if env::var_os("CARGO_FEATURE_OPENSSL_ON_WIN32").is_some() {
            ...
            // Enable elliptic-curve and Ed25519 algorithms.  The upstream
            // build.rs omits these on Windows MSVC, causing libssh2 to
            // skip curve25519-sha256 / ecdh-sha2-nistp* / ssh-ed25519
            // which are required by modern OpenSSH servers.
            cfg.define("HAVE_EC", None);
            cfg.define("HAVE_ED25519", None);
            cfg.define("HAVE_EVP_PKEY_ED25519", None);
